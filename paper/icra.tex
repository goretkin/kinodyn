...
\documentclass[twocolumn,english,letterpaper, conference]{IEEEtran}
\usepackage{lmodern}
...
version of the \rrtstar algorithm that uses an affine quadratic regulator 
extension to
...
obstacle to the general applicability of \rrtstar. 
We demonstrate

...
differentiable cost function. The method consists of the RRT{*} sample-based
...
planning algorithm was extended to RRT{*} which provides probabilistic
optimality. It is straightforward to apply RRT{*} to kinematic motion
